...
public class BeispielTest {
	public static void main(String[] args) {
		...
		IFahrlehrerinBoundary fahrlehrerinBoundary =
			driveNowSystem.getFahrlehrerinBoundary();
		ISekretaerBoundary sekretaerBoundary =
			driveNowSystem.getSekretaerBoundary();
